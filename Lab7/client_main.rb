...
begin 
  ...
  if(options.get_udp_socket)
    Transmitter::start_udp_client(options.get_port_number, options.get_host_name, options.get_filepath)
  else
    Transmitter::start_tcp_client(options.get_port_number, options.get_host_name, options.get_filepath)
  end
